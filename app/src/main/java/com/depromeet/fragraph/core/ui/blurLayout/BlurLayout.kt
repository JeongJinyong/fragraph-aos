...
class BlurLayout : FrameLayout {
    ...
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        ...
        mImageView = RoundedImageView(getContext()).apply {
    ...
    private fun blur(): Bitmap? {
        ...
        if(WeakReference(activityView).get() == null) Timber.d("mActivityView check")
        ...
        val pointRelativeToActivityView = if (mPositionLocked) {
            // Generate a locked point if null.
            mLockedPoint ?: kotlin.run {
        ...
        val x = (pointRelativeToActivityView.x * mDownscaleFactor) as Int
        val y = (pointRelativeToActivityView.y * mDownscaleFactor) as Int
...
//        Timber.d("get bitmap")
//        if (bitmap == null) Timber.d("bitmap is null")
...
//        Timber.d("get bitmap1")
//        if (bitmap == null) Timber.d("bitmap1 is null")
    ...
    private fun getDownscaledBitmapForView(view: View, crop: Rect, downscaleFactor: Float): Bitmap {
        ...
        val width = (crop.width() * downscaleFactor) as Int
        val height = (crop.height() * downscaleFactor) as Int
    ...
    fun lockView() {
        mViewLocked = true
        if (mActivityView != null && mActivityView!!.get() != null) {
            val view: View = mActivityView!!.get()!!.rootView
            try {
                super.setAlpha(0f)
